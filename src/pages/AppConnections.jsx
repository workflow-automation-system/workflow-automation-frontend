  ...
  return (
    <div className="space-y-5 font-urbanist">
      <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
        <div>
          <h1 className="text-3xl font-bold text-[#212121]">App Connections</h1>
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-4">
        <div className="enterprise-card p-5">
          <div className="mb-3 w-fit rounded-xl border border-[#D8DFE9] bg-[#CFDECA] p-2.5">
            <Database size={18} className="text-[#212121]" />
          </div>
          <p className="text-3xl font-bold text-[#212121]">12</p>
          <p className="text-sm text-[#5C5C5C]">Connected Apps</p>
        </div>
        <div className="enterprise-card p-5">
          <div className="mb-3 w-fit rounded-xl border border-[#D8DFE9] bg-[#EFF0A3] p-2.5">
            <Webhook size={18} className="text-[#212121]" />
          </div>
          <p className="text-3xl font-bold text-[#212121]">26</p>
          <p className="text-sm text-[#5C5C5C]">Webhook Endpoints</p>
        </div>
        <div className="enterprise-card p-5">
          <div className="mb-3 w-fit rounded-xl border border-[#D8DFE9] bg-[#D8DFE9] p-2.5">
            <KeyRound size={18} className="text-[#212121]" />
          </div>
          <p className="text-3xl font-bold text-[#212121]">18</p>
          <p className="text-sm text-[#5C5C5C]">Rotated API Keys</p>
        </div>
        <div className="enterprise-card p-5">
          <div className="mb-3 w-fit rounded-xl border border-[#D8DFE9] bg-[#CFDECA] p-2.5">
            <ShieldCheck size={18} className="text-[#212121]" />
          </div>
          <p className="text-3xl font-bold text-[#212121]">99.99%</p>
      ...
      <section className="enterprise-card overflow-hidden">
        <div className="flex flex-col gap-3 border-b border-[#D8DFE9] px-5 py-4 md:flex-row md:items-center md:justify-between">
          <div>
            <h2 className="text-lg font-semibold text-[#212121]">Connected Apps</h2>
        ...
        <div className="divide-y divide-[#D8DFE9]">
          {connections.map((connection) => (
            <div key={connection.name} className="flex flex-col gap-3 px-5 py-4 lg:flex-row lg:items-center lg:justify-between">
              <div>
                <p className="text-sm font-semibold text-[#212121]">{connection.name}</p>
                <p className="text-xs text-[#5C5C5C]">{connection.domain}</p>
              </div>

              <div className="flex flex-wrap items-center gap-3 text-xs text-[#5C5C5C]">
                <span className="rounded-full border border-[#D8DFE9] bg-white px-3 py-1">{connection.scopes} scopes</span>
                <span className="rounded-full border border-[#D8DFE9] bg-white px-3 py-1">Last sync {connection.lastSync}</span>
                {connection.status === 'Healthy' ? (
                  <span className="inline-flex items-center gap-1 rounded-full bg-[#CFDECA] px-2.5 py-1 font-semibold text-[#212121]">
                    <CheckCircle2 size={12} />
                    Healthy
                  </span>
                ) : (
                  <span className="inline-flex items-center gap-1 rounded-full bg-[#EFF0A3] px-2.5 py-1 font-semibold text-[#212121]">
                    <AlertCircle size={12} />
                    Warning
                  </span>
                )}
      ...
      <section className="enterprise-card p-5">
        <h2 className="text-lg font-semibold text-[#212121]">Available Integrations</h2>
        ...
        <div className="mt-4 grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-4">
          {availableIntegrations.map((integration) => (
            <button
              ...
              type="button"
              className="rounded-2xl border border-[#D8DFE9] bg-white p-4 text-left hover:border-[#CFDECA]"
            >
              <p className="text-sm font-semibold text-[#212121]">{integration.name}</p>
